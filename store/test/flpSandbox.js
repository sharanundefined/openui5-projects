					...
					"config": {
						"inbounds": {
							"Store-display": {
								...
								"action": "display",
								"description": "Store Application - Standard",
								"title": "Store",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sharan.project.store",
									"url": sap.ui.require.toUrl("com/sharan/project/store")
								}
							}
						}
					}
